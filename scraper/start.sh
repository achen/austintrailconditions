...
crontab -l 2>/dev/null | grep -vF "scrape.js" | grep -vF "scrape-reimers.js" | grep -vF "scrape-bcr.js" | grep -vF "scrape-rpr.js" | { cat; echo "$FB_CRON"; echo "$REIMERS_CRON"; echo "$BCR_CRON"; echo "$RPR_CRON"; } | crontab -
